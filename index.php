...
<html><!-- Mirrored from editfly-chk.xyz/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Oct 2018 02:18:04 GMT --><!-- Added by HTTrack --><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><!-- /Added by HTTrack -->
    ...
    <title id="title">𝑮𝑨𝑻𝑬 𝑬𝑳𝑶 𝟔𝟓</title>
              ...
              <div class="row">
                ...
                <div class="statistics col-lg-3 col-s12">
                  <div class="statistic d-flex align-items-center bg-white has-shadow">
                    ...
                    <div class="text"><strong id="cLive">0</strong><br><small>Aprovadas</small></div>
                  </div>
                  <div class="statistic d-flex align-items-center bg-white has-shadow">
                ...
                <div class="statistic d-flex align-items-center bg-white has-shadow">
                 ...
                 <div class="statistics col-lg-9 col-12">
                  <div class="statistic bg-white has-shadow">
                    ...
                    <center>
                 <textarea rows="7" placeholder="𝑪𝑶𝑳𝑶𝑸𝑼𝑬 𝑨𝑸𝑼𝑰 𝑺𝑼𝑨 𝑳𝑰𝑺𝑻𝑨 𝑫𝑬 𝑮𝑮 𝑬𝑳𝑶, 𝑮𝑨𝑻𝑬 𝑺𝑻𝑹𝑰𝑷𝑬" class="form-control" id="list" style="resize: none; outline: 0; text-align: center; width: 100%;"></textarea>
                 ...
                 <button disabled="" id="stop" style="float: left; width: 48%; margin-left: 3%;" class="btn btn-danger"><i class="fa fa-pause"></i> Pausar</button><br>
               </center>
             </blockquote>
                  </div>
                </div>
...
<div style="margin-top: 10px;" class="statistics col-lg-20 col-12">
                  <div class="articles card">
                    ...
                    <span class="pull-right">
                      <button type="button" class="btn btn-xs btn-danger" onclick="document.getElementById('lives').innerHTML = ''"><i class="fa fa-close"> Apagar </i></font></button>
                    </span>
                      </div>
                    </div>

                    <div class="card-header d-flex align-items-center">
                      <h2 class="h3">Aprovadas <i class="fa fa-check"></i></h2>
                  ...
                  <div class="articles card">
                    <div class="card-close">
                      <div class="dropdown">
                                                    ...
                                                    <span class="pull-right">
                                            <button type="button" class="btn btn-xs btn-danger" onclick="document.getElementById('employe').innerHTML = ''"><i class="fa fa-close"> Apagar </i></font></button>
                                        </span>
                      </div>
                    </div>

                    <div class="card-header d-flex align-items-center">
                      <h2 class="h3">Reprovadas <i class="fa fa-close"></i></h2>
